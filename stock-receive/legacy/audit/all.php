<?php
$page_title = "All Audit Trail - Stock Receive System";
...
$stmt = $conn->prepare("SELECT COUNT(*) as total FROM audit_trail");
$stmt->execute();
...
$stmt = $conn->prepare("SELECT * FROM audit_trail ORDER BY changed_at DESC LIMIT ? OFFSET ?");
...
<h2>All Audit Trail</h2>
<p>This page shows all changes made to the system.</p>
