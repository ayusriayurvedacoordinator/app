...
<head>
    ...
    <title><?php echo isset($page_title) ? $page_title : 'Stock Receive System'; ?></title>
    <!-- Local Bootstrap CSS -->
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="/stock-receive/vendors/index.php">View Vendors</a></li>
                            <li><a class="dropdown-item" href="/stock-receive/vendors/add.php">Add Vendor</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">Invoices</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="/stock-receive/invoices/index.php">View Invoices</a></li>
                            <li><a class="dropdown-item" href="/stock-receive/invoices/add.php">Add Invoice</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">Stock</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="/stock-receive/stock_recounts/index.php">Stock Recounts</a></li>
                            <li><a class="dropdown-item" href="/stock-receive/invoices/index.php">Invoices</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">Settings</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="/stock-receive/settings/index.php">Categories</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
